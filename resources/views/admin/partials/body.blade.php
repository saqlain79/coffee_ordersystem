              ...
              <div class="col-xl-3 col-sm-6 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <h6 class="text-muted font-weight-normal">Total Order Recieved</h6>
                  </div>
                </div>
              </div>
              <div class="col-xl-3 col-sm-6 grid-margin stretch-card">
                  ...
                  <div class="card-body">
                    <div class="row">
                      <div class="col-9">
                        <?php
                            use Carbon\Carbon;
                            $revenuetoday = DB::table('orders')->whereDate('created_at', Carbon::today())->sum('price');
                        ?>
                        <div class="d-flex align-items-center align-self-start">
                          <h3 class="mb-0">{{$revenuetoday}}</h3>
                        </div>
                      </div>
                      <div class="col-3">
                        <div class="icon icon-box-success ">
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="row">
                      <div class="col-9">
                        <?php
                          $totalemployee = DB::table('users')->where('role','=','employee')->count();
                        ?>
                        <div class="d-flex align-items-center align-self-start">
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="row">
                      <div class="col-9">
                        <?php
                            $totaldeliveryteam = DB::table('users')->where('role','=','deliveryteam')->count();
                        ?>
                        <div class="d-flex align-items-center align-self-start">
                          <h3 class="mb-0">{{$totaldeliveryteam}}</h3>
                        </div>
                      </div>
                      <div class="col-3">
                        <div class="icon icon-box-success ">
                    ...
                    <h6 class="text-muted font-weight-normal">Total Delivery Team</h6>
                  </div>
                </div>
              </div>
            </div>
