...
<html>
   ...
   <body>
      <div class="">
        ...
        <div>
            <h1 class="form-group" style="font-size:30px">User Details</h1>
            @if(Auth::check())
            @auth
            ...
            <h1 class="form-group" style="font-size:30px">Cart</h1>
                <table class="table" style="width:60%; margin:auto; padding:10px">
                    <thead class="thead-light">
                        ...
                        <tr style="text-align:center">
                            ...
                            <td>{{$cart->quantity}}</td>
                            <td>${{$cart->price}}</td>
                            <td><img style="height:150px; width:150px" src="/img/{{$cart->image}}" alt=""></td>
                            <td>
                              <a onclick="return confirm ('Are you sure?')" href="{{route('delete_cart',$cart->id)}}" class="btn btn-danger">Delete</a>
                            </td>
                        </tr>
                ...
                <div style="padding:10px">
                    ...
                    <a href="{{route('cash_payment')}}" class="btn btn-danger">Cash Payment</a>
                    <a href="{{route('stripe_payment', $total)}}">Pay by Card</a>
                </div>
