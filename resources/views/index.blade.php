        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="row align-items-center mb-5">
                        <div class="col-4 col-sm-3">
                            <img class="w-100 rounded-circle mb-3 mb-sm-0" src="{{asset('img/'.$product2->image)}}" alt="">
                            @if($product2->sale_price > 0)
                            <h5 class="menu-price">${{$product2->sale_price}}</h5>
                            @else
                            <h5 class="menu-price">${{$product2->price}}</h5>
                            @endif
                        </div>
                        <div class="col-8 col-sm-9">
                            <h4><a href="{{route('single_product',$product2->id)}}">{{$product2->name}}</a></h4>
                            <p class="m-0">{{$product2->description}}</p>
                        </div>
                    </div>
